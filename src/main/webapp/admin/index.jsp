    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">
                <p style="font-style:italic;color:red;font-size:18px">别爱我没结果</p></a>
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="#">切换账户</a></li>
                            <li><a href="User?action=logout">退出</a></li>
                        </ul>
                    </li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href="" data-title="评论记录" href="javascript:void(0)">评论记录</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="/goods/getAll" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>
                </ul>
            </dd>
        </dl>
    </div>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="_blank.html">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="_blank.html"></iframe>
        </div>
    </div>
</section>
